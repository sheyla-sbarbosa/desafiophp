...
if(empty(!$_FILES)){$_foto = $_FILES['foto'];

  $preco = $_POST['preco'];

  if(is_float($preco)) {
    echo "tudo certo"
  } else {echo "esse preço não é um número válido"}
...
<html lang="pt-br">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="float" name="precoProduto" class="form-control" id="precoProduto">
    </div>

    
    <div class="form-group col-md-12">
    <label for="descricaoProduto">Descrição</label>
    <textarea class="form-control" name="descricaoProduto" id="descricaoProduto" rows="6"></textarea>
  </div>
